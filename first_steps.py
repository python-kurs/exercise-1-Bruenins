...
b = 345
v_1 = a - b
# a is an integer, b is float, v_1 is float
...
# No beacuse it is'nt in the range of the VIS
...
print("Pi rounded to the first " + str(n) + " decimals is: " + str("{0:6.10f}".format(pi)))
